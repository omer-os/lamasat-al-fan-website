...
export default function CTAcard({ projects, contact, services }) {
  ...
  return (
    <div
      dir={lang === "ar" ? "rtl" : "ltr"}
      className="flex items-center justify-center relative h-[20em] rounded-xl sm:mx-20 flex-col mb-10 mx-5 transition-all p-4"
    >
      ...
      {projects && (
        <div className="items-center text-center">
          ...
          <p className="mt-3 mb-6 text-lg leading-relaxed text-slate-400">
