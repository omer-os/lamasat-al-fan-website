...
export default function Test2() {
  ...
  return (
    <div className="min-h-screen">
      <div className="sm:-z-10 sm:absolute relative top-0 left-0 sm:h-full  sm:rounded-none rounded-xl sm:overflow-hidden sm:w-[50%] sm:mt-0 mt-24 sm:mx-0  mx-0">
        ...
        <div className="flex overflow-x-scroll snap-display-none snap-x snap-mandatory gap-4 sm:hidden px-8">
          {dta.map((i, index) => (
            <div className="relative">
              <motion.img
                key={index}
                className={`snap-center min-w-[19em] rounded-xl h-[23em] top-0 left-0 z-10 object-cover`}
                src={dta[index].bg}
              />
